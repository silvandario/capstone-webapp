...
if st.session_state.show_description:
    ...
    descriptions = {
        ...
        'Druck auf die Altersvorsorge': "Der Demografische Wandel in Deutschland ist allen bekannt und unumstritten. Er stellt die deutsche Regierung und Bevölkerung bereits heute unter enormen Handlungsdruck. Der Arbeitskräftemangel kann diesen Druck in Zukunft noch weiter erhöhen, was zu enormen sozialen und politischen Problemen führen kann. Neben der Altersvorsorge hat der Arbeitskräftemangel das Potenzial, sich negativ auf jegliche weitere Sozialversicherung auszuwirken.",
